...
class rubiks_cube_rotate_bottom_counter_clock_wise: public testing::Test
{   
    protected:
...
TEST_F(rubiks_cube_rotate_bottom_counter_clock_wise, two_sided)
{
    _aux = {WHITE, GREEN, 
            RED  , WHITE};
    ...
    _cube.rotate_face_counter_clock_wise(BOTTOM, 1);

    ASSERT_EQ(_resulting_cube, _cube);
}

TEST_F(rubiks_cube_rotate_bottom_counter_clock_wise, three_sided)
{
