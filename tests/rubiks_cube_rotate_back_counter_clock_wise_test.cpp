...
class rubiks_cube_rotate_back_counter_clock_wise_test: public testing::Test
{   
    protected:
...
TEST_F(rubiks_cube_rotate_back_counter_clock_wise_test, two_sided)
{
    _aux = {WHITE, GREEN, 
            RED  , WHITE};
...
TEST_F(rubiks_cube_rotate_back_counter_clock_wise_test, three_sided)
{
